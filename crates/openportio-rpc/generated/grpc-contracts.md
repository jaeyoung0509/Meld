...
### `openportio.v1.Greeter`

- `SayHello`: `openportio.v1.HelloRequest` -> `openportio.v1.HelloResponse` (client_streaming=false, server_streaming=false)

## Messages

### `openportio.v1.HelloRequest`

- `name` (`string`, field #1)

### `openportio.v1.HelloResponse`
